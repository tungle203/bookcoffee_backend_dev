...
router.post('/addAuthor', verifyToken, verifyPermission(['admin']), adminController.addAuthor);
...
router.post('/addDrinks', verifyToken, verifyPermission(['admin']), uploadImage('drinksImage', process.env.DRINKS_PATH),adminController.addDrinks);
