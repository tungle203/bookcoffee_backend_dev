...
class AdminController {
    ...
    VALUES (?,?)';
        const values = [req.body.authorName, new Date(req.body.bornDate)];
    ...
    addBranch(req, res) {
        ...
        if (!address || !workingTime || !managerName || !password)
    ...
    addBook(req, res) {
        ...
        if (!title || !genre || !publicationYear || !salePrice || !authorName)
            return res.sendStatus(400);
